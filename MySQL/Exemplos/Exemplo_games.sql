...
select * from tb_produtos inner join tb_usuarios on tb_usuarios.id = tb_produtos.usuario_id;

-- Juntando todas tabelas
select * from tb_produtos inner join  tb_categorias on tb_categorias.id = tb_produtos.categoria_id inner join tb_usuarios on tb_usuarios.id = tb_produtos.usuario_id;
