...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_usuarios` (
  ...
  PRIMARY KEY (`id`, `tb_categorias_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  `tb_usuarios_tb_categorias_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`, `tb_categorias_id`, `tb_usuarios_id`, `tb_usuarios_tb_categorias_id`),
  INDEX `fk_tb_produtos_tb_categorias_idx` (`tb_categorias_id` ASC) VISIBLE,
  INDEX `fk_tb_produtos_tb_usuarios1_idx` (`tb_usuarios_id` ASC, `tb_usuarios_tb_categorias_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_produtos_tb_usuarios1`
    FOREIGN KEY (`tb_usuarios_id` , `tb_usuarios_tb_categorias_id`)
    REFERENCES `db_loja_games`.`tb_usuarios` (`id` , `tb_categorias_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
